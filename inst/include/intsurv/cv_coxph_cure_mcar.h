...
#ifndef INTSURV_CV_COXPH_CURE_MCAR_H
#define INTSURV_CV_COXPH_CURE_MCAR_H
        ...
        for (size_t i {0}; i < n_folds; ++i) {
            ...
            arma::vec train_time {
                arma::join_vert(
                    ...
                    time_case3.elem(cv_obj_case3.train_index_.at(i))
                    )
            };
            arma::vec train_event {
                arma::join_vert(
                    ...
                    event_case3.elem(cv_obj_case3.train_index_.at(i))
                    )
            };
            arma::mat train_cox_x {
                arma::join_vert(
                    ...
                    cox_x_case3.rows(cv_obj_case3.train_index_.at(i))
                    )
            };
            arma::mat train_cure_x {
                arma::join_vert(
                    ...
                    cure_x_case3.rows(cv_obj_case3.train_index_.at(i))
                    )
            };
            arma::vec train_cox_offset {
                arma::join_vert(
                    ...
                    cox_offset_case3.elem(cv_obj_case3.train_index_.at(i))
                    )
            };
            arma::vec train_cure_offset {
                arma::join_vert(
                    ...
                    cure_offset_case3.elem(cv_obj_case2.train_index_.at(i))
                    )
            };
            // testing set
            arma::vec test_time {
                arma::join_vert(
                    ...
                    time_case3.elem(cv_obj_case3.test_index_.at(i))
                    )
            };
            arma::vec test_event {
                arma::join_vert(
                    ...
                    event_case3.elem(cv_obj_case3.test_index_.at(i))
                    )
            };
            arma::mat test_cox_x {
                arma::join_vert(
                    ...
                    cox_x_case3.rows(cv_obj_case3.test_index_.at(i))
                    )
            };
            arma::mat test_cure_x {
                arma::join_vert(
                    ...
                    cure_x_case3.rows(cv_obj_case3.test_index_.at(i))
                    )
            };
            arma::vec test_cox_offset {
                arma::join_vert(
                    ...
                    cox_offset_case3.elem(cv_obj_case3.test_index_.at(i))
                    )
            };
            arma::vec test_cure_offset {
                arma::join_vert(
                    ...
                    cure_offset_case3.elem(cv_obj_case2.test_index_.at(i))
                    )
            };
            // define object
