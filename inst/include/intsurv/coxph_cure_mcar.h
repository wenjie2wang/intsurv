...
namespace Intsurv {
        ...
        )
    {
        ...
        arma::vec event { cox_obj_.get_event() };
        ...
        arma::vec cox_exp_x_beta = arma::exp(cox_obj_.get_x() * cox_beta);
        ...
        c_index_ = Intsurv::Concordance(
            cox_obj_.get_time().elem(cer_ind_),
            cox_obj_.get_event().elem(cer_ind_),
