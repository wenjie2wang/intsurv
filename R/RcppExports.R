...
coxph_cure_reg <- function(time, event, cox_x, cure_x, cure_intercept = TRUE, cox_lambda = 0L, cox_nlambda = 1L, cox_lambda_min_ratio = 1e-4, cox_penalty_factor = 0L, cure_lambda = 0L, cure_nlambda = 1L, cure_lambda_min_ratio = 1e-4, cure_penalty_factor = 0L, cox_start = 0L, cure_start = 0L, em_max_iter = 1000L, em_rel_tol = 1e-3, cox_mstep_max_iter = 30L, cox_mstep_rel_tol = 1e-3, cure_mstep_max_iter = 30L, cure_mstep_rel_tol = 1e-6) {
