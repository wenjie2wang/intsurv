                     ...
                     verbose = FALSE, ...)
{
    ...
    ## on tail completion
    all_tails <- c("zero", "exp", "zero-after-tau")
...
##' @seealso
##'
##' \code{\link{cox_cure}} for fitting Cox cure rate model for given model
##' formulas; \code{\link{cox_cure_net}} for regularized Cox cure rate model
##' with elastic-net penalty.
##'
##' @example inst/examples/cox_cure.R
##' @export
